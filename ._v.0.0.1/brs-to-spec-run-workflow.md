...
| 12 | Quality gates | `quality-gates/<gate>.md` (triggered gates only) | Each gate: real content, ticked checklist, `Status: Accepted` — stub or In progress fails | `4-engineering-readiness/quality-gates/create-<gate>.md` | (8)(11) |
