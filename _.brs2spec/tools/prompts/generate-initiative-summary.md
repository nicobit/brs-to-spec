...
- `state/routing-decision.md` — delivery mode, execution mode, rationale
- `business-intake/business-intake-summary.md` — objectives, scope, requirements, constraints
- `state/workflow-state.json` — current stage and status
- `state/open-decisions.md` — open and resolved decisions summary
