...
This file contains the binding architecture rules, governed boundaries, and rollback sensitivity for this deliverable. Use it as the primary constraint reference before reading individual architecture artifacts.
...
specs/D1-<deliverable-name>/design.md
...
1. What is the strongest argument that this implementation is actually compliant with the architecture constraints?
2. Which constraint, if misread, would make a blocking finding look non-blocking?
3. What would a future maintainer break first if they followed the patterns introduced by this implementation?
