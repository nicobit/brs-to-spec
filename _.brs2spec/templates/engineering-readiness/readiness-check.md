...
<!-- Readiness score: count 1 point per checklist item with Status = Pass, divide by total items, multiply by 100. -->
<!-- 90–100: Ready. 70–89: Ready with risks (list conditions). Below 70: Not ready. -->
<!-- Record the score here so it is visible without reading the full checklist. -->
...
|---|---|---|---|---|---|---|---|
| BDD scenarios |  |  |  |  | PO/QA | Implementation | `quality-gates/bdd/` (one file per feature + `acceptance-checklist.md`) |
