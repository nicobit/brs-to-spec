...
> Used by the handoff skill to derive candidate file paths in coding-prompt.md.
...
> Copied **verbatim** into coding-prompt.md for every story in this repo — do not use placeholder names.
...
> Merged into the "What you must NOT do" section of every coding-prompt.md for this repo.
