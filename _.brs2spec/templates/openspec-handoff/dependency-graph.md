...
>
> **Mermaid syntax rules:** apply canonical rules from `.brs2spec/agent-instructions.md` → Mermaid syntax rules — canonical source. Node IDs follow the story ID convention: `F-001.1` → `F001_1`. Repo-subfolder nodes: `F001_1_api`, `F001_1_ui`.
>
