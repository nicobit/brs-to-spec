...
After delivery planning is complete (epics, features, stories are defined). This skill validates every story against 11 quality checks before BDD generation and handoff.
...
11. **AI-safe to implement** — Could an AI coding agent implement this safely?
