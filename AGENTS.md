# BRS to Spec Framework — Codex Instructions
...
| "status" / "what is next" | Read `.b2s/state/workflow-state.json` and `.b2s/state/next-step.json` when present |
| "repair processing" / "fix processing" | Read and follow `.github/prompts/b2s-repair-chain.prompt.md` |
| "reset to <phase>" / "rewind to <phase>" | Read and follow `.github/prompts/b2s-reset-to-phase.prompt.md` |
| "resume" / "resume from <phase>" | Read and follow `.github/prompts/b2s-resume.prompt.md` |
| "rerun" / "redo last" / "rerun last action" | Read and follow `.github/prompts/b2s-rerun-last-action.prompt.md` |
| "b2s-help" / "help" / "b2s-help <phase or action>" | Read and follow `.github/prompts/b2s-help.prompt.md` |
