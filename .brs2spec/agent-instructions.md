...
| Reviewer | `@reviewer` | `9-reviewers/01-senior-code-review.md` (default) — see `module.md` Phase 9 for full list | Code review, QA review, architecture review, security review |
