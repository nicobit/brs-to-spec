...
|---|---|---|---|
| Business intake | .brs2spec/2-business-intake/01-create-business-intake-summary.md | Yes | `business-intake/business-intake-summary.md` is a stub and must be populated with owners, acceptance, and gaps. |
| Architecture review | .brs2spec/3-planning-and-modular-delivery/01-review-initial-architecture.md | Yes | Draft architecture was generated; review must be completed and architect must mark review status. |
