...
|---|---|---|---|
| 1 | skills/0-input-preparation/04-draft-architecture-from-brs.md | Yes | `input/architecture.md` is currently a stub; draft architecture is required to define interfaces, boundaries and DRAFT diagrams before review. |
| 2 | skills/3-planning-and-modular-delivery/01-review-initial-architecture.md | Yes | Architect must review the draft architecture and capture constraints and open decisions. |
| 3 | skills/3-planning-and-modular-delivery/03-create-delivery-structure.md | Conditional | Draft exists but features/stories should be reviewed and expanded after architecture review. |
